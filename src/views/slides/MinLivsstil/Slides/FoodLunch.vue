...
import LunchSmall from '@/components/food-illustrations/LunchSmall.vue';
import LunchMedium from '@/components/food-illustrations/LunchMedium.vue';
import LunchLarge from '@/components/food-illustrations/LunchLarge.vue';
...
async function handleChange(value) {
  await store.setProfileValue('energyIntakeNewLunch', value);
}
</script>

<template>
  <div class="px-8 mt-8 gap-y-4 w-full">
    <h3 class="m-0 font-light">Lunch</h3>

    <p class="text-base mt-1">Hur ser din lunch oftast ser ut. Är den liten mellan eller stor?</p>
    ...
    <dialog :open="showExplanation" class="bg-green-light border-none rounded-md shadow-2xl z-50 mt-6 mx-auto explanation-dialog">
      <div class="flex flex-col items-center">
        ...
        <div v-if="explanationType === 'small'">
          <strong>Exempel på liten lunch</strong>

          <p>
            1 liten sallad med dressing<br>
            eller en smörgås o kaffe
          </p>

          <p>eller</p>

          <p class="mb-0">1 liten portion lagad mat:</p>
          <ul class="mt-0">
            <li>½ tallrik grönsaker</li>
        ...
        <div v-if="explanationType === 'medium'">
          <strong>Exempel på mellanstor lunch</strong>

          <p>En sallad med dressing, bröd o mjölk/<br>annan dryck (ej vatten)</p>
    ...
    <ul class="flex flex-col my-0 p-0 gap-y-2">
      <li class="list-none">
        <button class="flex items-center text-base gap-x-1 bg-transparent" @click="openExplanation('small')">
          ...
          <span>Vad är en liten lunch?</span>
        </button>
      </li>
      ...
      <b-radio-item
        ...
        :data="{ label: 'Liten lunch', value: 1, icon: LunchSmall }"
        :index="0"
      ...
      <li class="list-none mt-2">
        <button class="flex items-center text-base gap-x-1 bg-transparent" @click="openExplanation('medium')">
          ...
          <span>Vad är en mellanstor lunch?</span>
        </button>
      </li>
      ...
      <b-radio-item
        ...
        color-scheme="green"
        name="energyIntakeNewLunch"
        :data="{ label: 'Mellanstor lunch', value: 2, icon: LunchMedium }"
        :index="1"
      ...
      <li class="list-none mt-2">
        <button class="flex items-center text-base gap-x-1 bg-transparent" @click="openExplanation('large')">
          ...
          <span>Vad är en stor lunch?</span>
        </button>
      </li>
      ...
      <b-radio-item
        ...
        color-scheme="green"
        name="energyIntakeNewLunch"
        :data="{ label: 'Stor lunch', value: 3, icon: LunchLarge }"
        :index="2"
      ...
      <b-radio-item
        ...
        color-scheme="green"
        name="energyIntakeNewLunch"
        :data="{ label: 'Äter inte lunch', value: 0, }"
        :index="3"
